...
public class TeacherDetails extends JFrame {
    ...
    private Table teacherTable = new Table();
    ...
    public TeacherDetails() {
        ...
        teacherTable.render(columnNames);
...
//        setDefaultCloseOperation(EXIT_ON_CLOSE); // exit when closing
    ...
    private void $$$setupUI$$$() {
        ...
        jPanel1.add(buttonPanel, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, null, null, 0, false));
        addTeacherButton = new JButton();
        addTeacherButton.setText("Add Teacher");
        buttonPanel.add(addTeacherButton, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        deleteTeacherButton = new JButton();
        deleteTeacherButton.setText("Delete Teacher");
        buttonPanel.add(deleteTeacherButton, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        jPanel1.add(scrollPane1, new GridConstraints(2, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_WANT_GROW, null, null, null, 0, false));
    }
    ...
    private void createUIComponents() {
        ...
        scrollPane1 = new JScrollPane(teacherTable);
