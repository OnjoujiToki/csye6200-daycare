 ...
 *
 */
public class PreSchoolImmunizationRules implements FileOpsAPI{
	/*
	 * preschool immunization rules in  csv according to drug type, Dose Number 
	...
	public String fileName3 = "/home/jeff/Desktop/PreSchoolImmunizationRules.csv" ;		
	...
	public void writeToCSV() {
		try {			
			...
			System.out.println("\nObjects have been successfully written to PreSchoolImmunizationRules.csv file!");
			out.flush();
			out.close();
		} catch (Exception e) {
